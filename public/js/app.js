...
__webpack_require__(/*! ./callback */ "./resources/js/callback.js");
...
jQuery(document).ready(function ($) {
  ...
  jQuery('#success').on('submit', function (e) {
    ...
    if (success.transaction.status == 'success') {
      ...
      $.redirectPost(redirect, {
        order_status: success.order.status
      });
    }
  });
  jQuery('#fail').on('submit', function (e) {
    ...
    if (fail.transaction.status == 'fail') {
      var redirect = 'sorry';
      $.redirectPost(redirect, {
        transaction_id: fail.transaction.id,
        transaction_operation: fail.transaction.operation,
        transaction_status: fail.transaction.status,
        order_status: fail.order.status
      });
    }
  });
});
